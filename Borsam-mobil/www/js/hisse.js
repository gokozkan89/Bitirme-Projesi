(function () {
  ...
  function HisseController(hisseService, $ionicLoading, $timeout, $stateParams) {
    var vm;
    ...
    function getirListe() {
      ...
      hisseService.yahooAll(hisseListesi).then(success).catch(error).finally(finished);
  ...
  HisseController.$inject = ["hisseService", "$ionicLoading", "$timeout", "$stateParams"];
